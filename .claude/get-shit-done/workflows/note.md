...
- **Global scope**: `/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/notes/`)
...
2. Glob `/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/notes/` — works in any directory
