...
Use template from `/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/mykhailomykhailenko/work/personal/vasyl/remonty/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
