...
| 01-01-03 | 01 | 1 | TRST-01 | data integrity | `./scripts/qa.sh` + placeholder identity check | ✅ | ⬜ pending |
...
| 01-03-02 | 03 | 3 | TRST-04 | data + rendered | `./scripts/qa.sh` + sourced-proof check | ✅ | ⬜ pending |
| 01-03-03 | 03 | 3 | TRST-01 | validation artifact | `test -f .planning/phases/01-trust-and-phone-foundation/01-VALIDATION.md` | ✅ | ⬜ pending |
| 01-03-04 | 03 | 3 | TRST-04 | sign-off gate | `./scripts/qa.sh` + sourced-proof check | ✅ | ⬜ pending |
...
- [ ] Extend `scripts/qa.sh` or add a Phase 1 validation helper to fail on placeholder phone/email/business identity data.
...
| Trust signals feel concrete rather than generic | TRST-01 / TRST-03 / TRST-04 | Credibility depends on content specificity and sourcing quality | Review core pages and confirm trust blocks cite real business facts, fit criteria, accountability language, and sourced proof |
...
- [ ] Wave 0 guardrails cover placeholder identity data, bilingual shared-data completeness, required tel-link route coverage, sticky CTA overlap, and messenger-secondary hierarchy checks
- [ ] No watch-mode flags
