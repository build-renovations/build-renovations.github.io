...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 01-01-01 | 01 | 1 | TRST-01 | build + rendered | `./scripts/qa.sh` | ✅ | ⬜ pending |
| 01-01-02 | 01 | 1 | CALL-01 | rendered | `./scripts/qa.sh` + browser tel-link check | ✅ | ⬜ pending |
| 01-01-03 | 01 | 1 | CALL-03 | rendered mobile | `./scripts/qa.sh` + mobile sticky CTA check | ✅ | ⬜ pending |
...
- [ ] Add rendered browser checks for visible `a[href^="tel:"]` across required UA and EN routes.
