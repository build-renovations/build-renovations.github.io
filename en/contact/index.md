...
- Current condition: new build, resale property, partial renovation
- Needed stages: engineering, core construction, finishing
- Target start date and preferred completion window
- Whether there is an existing design package or procurement support is needed
