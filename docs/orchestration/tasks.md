...
| ORCH-004 | Harden GSD MCP routing defaults | orchestrator | done | repo_only | ORCH-002 | GSD workflows, MCP docs, and readiness checks now make Playwright-backed browser validation and ui-ux-pro-max concept generation explicit defaults |
